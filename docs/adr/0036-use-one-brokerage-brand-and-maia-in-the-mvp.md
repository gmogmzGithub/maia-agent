...
The homepage offers two primary paths: `Cuéntale a Maia qué estás buscando` and
`Explorar propiedades`. Maia is visible and contextual but does not open
automatically. A short editorial selection of six to eight Listings communicates
the catalog's range without turning the homepage into the complete search result.
